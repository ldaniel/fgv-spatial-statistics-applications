...
* Modelo GWR com stepwise.

Partindo do modelo mais simples, de regressão linear, notamos um R2 de $0.3277$ e ao aplicar o modelo SAR podemos ver que ele leva em conta o preço dos vizinhos. Ao aplicar o modelo GWR conseguimos notar a formação de **clusters**, contudo, para o Rio de Janeiro fica evidente um comportamento anômalo. 
