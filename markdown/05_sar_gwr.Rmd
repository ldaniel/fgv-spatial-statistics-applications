...
```{r gwr_stepwise_model, echo = TRUE, out.width = '100%', fig.height = 6, warning = FALSE, eval = FALSE, include=FALSE}
...
target.gwr.residuals.classes_fx <- classIntervals(target.gwr.residuals, n = 5, 
                                                  style = "fixed", 
                                                  fixedBreaks = c(-1, -.75, -.25, .25, .75, 1),
                                                  rtimes = 1)
cols.gwr.residuals <- findColours(target.gwr.residuals.classes_fx, pal)
