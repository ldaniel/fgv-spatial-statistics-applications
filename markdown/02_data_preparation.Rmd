...
Before starting the analysis for the {{Spatial-Statistics-Applications}}, a few important steps were taken in order to prepare the source data files. These steps are listed below:
